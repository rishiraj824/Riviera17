    ...
    $(document).ready(function() {
        ...
        .done(function(data) {
            for (var i = 0; i < data.length; i++) {
                $("#portfolio-grid").append('<div class="isotope-item portfolio-item wide '+ data[i]["MAIN CATEGORY"]+'"><div class="portfolio-media"><a href="#" class="thumb-overlay overlay-effect-1 text-light"><img src="files/uploads/portfolio-thumb-modern-2.jpg" alt="SEO IMG NAME"><div class="overlay-caption"><h6 class="caption-sub portfolio-category subtitle-2">'+data[i]["CATEGORY NAME"]+'</h6><hr class="zigzag"><h4 class="caption-name portfolio-name uppercase">'+data[i]["EVENT NAME"]+'</h4></div></a></div></div>');
            }
