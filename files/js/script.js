        ...
        .done(function(data) {
        	...
        	$.ajax({
        		...
        		.done(function(data3) {
        	        ...
        	        $("#portfolio-grid").append('<div class="isotope-item portfolio-item portfolio-new wide '+ data[i]["MAIN CATEGORY"]+'"><div class="portfolio-media"><a href="#" class="thumb-overlay overlay-effect-1 text-light"><img src="svg/pattern.png" style="background-size:cover;width:435px;height:auto;filter:brightness(70%);" alt="pattern"><div class="overlay-caption"><h6 class="caption-sub portfolio-category subtitle-2">'+data[i]["CATEGORY NAME"]+'</h6><hr class="zigzag"><h4 class="caption-name portfolio-name">'+data[i]["EVENT NAME"]+'</h4><h6 class="caption-sub subtitle-3">'+ data3[index]["DESCRIPTION"]+'<br> Event Amount: Rs.'+ data[i]["EVENT AMOUNT"]+'</h6><h6 class="caption-name portfolio-name ">Contact - '+ data2[i]["COORDINATOR 1"]+',' + data2[i]["COORDINATOR 2"]+',' +data2[i]["REG. NO."]+'</h6></div></a></div></div>');
